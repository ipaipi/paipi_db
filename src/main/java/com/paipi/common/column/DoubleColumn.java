...
public class DoubleColumn extends Column {
    ...
    public static final String TYPE_NAME = Type.DOUBLE.name();
    ...
    public BigDecimal asBigDecimal() {
        ...
        try {
            ...
            throw new DbAdapterException(String.format("String[%s] 无法转换为Double类型 .",
    ...
    public Boolean asBoolean() {
        throw new DbAdapterException("Double类型无法转为Bool .");
    }

    @Override
    public Date asDate() {
        throw new DbAdapterException("Double类型无法转为Date类型 .");
    }
    ...
    @Override
    public byte[] asBytes() {
        throw new DbAdapterException("Double类型无法转为Bytes类型 .");
    }
    ...
    private void validate(final String data) {
        ...
        try {
            ...
            throw new DbAdapterException(String.format("String[%s]无法转为Double类型 .", data));
        }
    }

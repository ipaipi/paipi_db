...
public class DateColumn extends Column {
    ...
    public static final String TYPE_NAME = Type.DATE.name();
    ...
    public String asString() {
        try {
            ...
            throw new DbAdapterException(String.format("Date[%s]类型不能转为String .", this.toString()));
        }
    }
    ...
    @Override
    public byte[] asBytes() {
        throw new DbAdapterException("Date类型不能转为Bytes .");
    }

    @Override
    public Boolean asBoolean() {
        throw new DbAdapterException("Date类型不能转为Boolean .");
    }

    @Override
    public Double asDouble() {
        throw new DbAdapterException("Date类型不能转为Double .");
    }

    @Override
    public BigInteger asBigInteger() {
        throw new DbAdapterException("Date类型不能转为BigInteger .");
    }

    @Override
    public BigDecimal asBigDecimal() {
        throw new DbAdapterException("Date类型不能转为BigDecimal .");
    }

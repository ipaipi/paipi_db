...
public class BoolColumn extends Column {
    ...
    public static final String TYPE_NAME = Type.BOOL.name();
    ...
    @Override
    public Date asDate() {
        throw new DbAdapterException("Bool类型不能转为Date .");
    }
    ...
    @Override
    public byte[] asBytes() {
        throw new DbAdapterException("Boolean类型不能转为Bytes .");
    }
    ...
    private void validate(final String data) {
        ...
        throw new DbAdapterException(String.format("String[%s]不能转为Bool .", data));
    }
}

...
public class StringColumn extends Column {
    ...
    public static final String TYPE_NAME = Type.STRING.name();
    ...
    private void validateDoubleSpecific(final String data) {
        if ("NaN".equals(data) || "Infinity".equals(data)
            ...
            throw new DbAdapterException(String.format("String[\"%s\"]属于Double特殊类型，不能转为其他类型 .", data));
        }
    ...
    public BigInteger asBigInteger() {
        ...
        try {
            ...
            throw new DbAdapterException(String.format("String[\"%s\"]不能转为BigInteger .", this.asString()));
        }
    }
    ...
    public Long asLong() {
        ...
        try {
            ...
            throw new DbAdapterException(String.format("String[\"%s\"]不能转为Long .", this.asString()));
        }
    }
    ...
    public BigDecimal asBigDecimal() {
        ...
        try {
            ...
            throw new DbAdapterException(String.format(
    ...
    public Boolean asBoolean() {
        ...
        throw new DbAdapterException(String.format("String[\"%s\"]不能转为Bool .", this.asString()));
    }
    ...
    public Date asDate() {
        try {
            ...
            throw new DbAdapterException(String.format("String[\"%s\"]不能转为Date .", this.asString()));
        }
    }
    ...
    public byte[] asBytes() {
        try {
            ...
            throw new DbAdapterException(String.format("String[\"%s\"]不能转为Bytes .", this.asString()));
        }
    }
}

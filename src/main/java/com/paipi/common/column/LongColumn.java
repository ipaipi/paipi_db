...
public class LongColumn extends Column {
    ...
    public static final String TYPE_NAME = Type.LONG.name();
    ...
    public LongColumn(final String data) {
        ...
        try {
            ...
            throw new DbAdapterException(String.format("String[%s]不能转为Long .", data));
        }
    }
    ...
    @Override
    public byte[] asBytes() {
        throw new DbAdapterException("Long类型不能转为Bytes .");
    }
